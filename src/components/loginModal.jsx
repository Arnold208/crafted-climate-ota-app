...
const LoginModal = () => {
  ...
  return (
    <>
      <button
        onClick={goConsole}
        className=" bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-r-4 hover:border-b-0 hover:border-t-4 border-blue-700 hover:border-blue-500 rounded"
        type="button"
      >
        Login
      </button>
      {/* <div className={`max-w-2xl mx-auto ${modalOpen ? "block" : "hidden"}`}>
        <div
